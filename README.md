...
Técnicas Ultilizadas: Este Projeto implementa varias funções, como css Grid, form, utilização de javascript, validação de formularios, classes, POO, desestruturação de objetos, entre outros.
